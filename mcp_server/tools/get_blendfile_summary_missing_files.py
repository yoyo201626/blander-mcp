...
from mcp_server.tools_helpers import (
    toolcode_format_call,
    toolcode_load_from_filepath,
    toolcode_wrap_with_calling_convention,
)
from mcp_server.tools_helpers.blender_cli import run_blender_cli, synced_blend_for_cli
from mcp_server.tools_helpers.connection import send_code
...
def register(mcp: FastMCP) -> None:
    ...
    @mcp.tool(
        annotations=ToolAnnotations(
            title="Get Blend-File Missing Files Summary for Command-Line",
            readOnlyHint=True,
        )
    )
